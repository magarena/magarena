                ...
                game.doAction(new MagicLookAction(card, upkeepPlayer, "top card of your library"));
                    ...
                    return card.hasSubType(subtype) == permanent.hasSubType(subtype) ?
                        new MagicEvent(
                            ...
                            card,
                            this,
                            "PN may\$ reveal the top card of PN's library. If you do, SN deals 2 damage to each creature."
                        ):
                        MagicEvent.NONE;
                    }
                }
        ...
        public void executeEvent(final MagicGame game, final MagicEvent event) {
            if (event.isYes()) {
                ...
                final Collection<MagicPermanent> targets = game.filterPermanents(MagicTargetFilterFactory.CREATURE);
                    ...
                    game.doAction(new MagicDealDamageAction(event.getPermanent(), target, 2));
                }
            }
        }
    }
