    ...
    new MagicSpellCardEvent() {
        ...
        public void executeEvent(final MagicGame game, final MagicEvent event) {
            ...
            final List<MagicCard> zombies =
                    game.filterCards(player,MagicTargetFilterFactory.TARGET_ZOMBIE_CREATURE_CARD_FROM_GRAVEYARD);
            ...
            final List<MagicPermanent> humans =
                    game.filterPermanents(player,MagicTargetFilterFactory.TARGET_HUMAN);
