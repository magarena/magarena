    ...
    new MagicAtYourUpkeepTrigger() {
                ...
                game.doAction(new MagicLookAction(card, upkeepPlayer, "top card of your library"));
                    ...
                    return card.hasSubType(subtype) == permanent.hasSubType(subtype) ?
                        new MagicEvent(
                            ...
                            card,
                            this,
                            "PN may\$ reveal the top card of PN's library. If you do, each opponent discards a card."
                        ):
                        MagicEvent.NONE;
                    }
                }
        ...
        public void executeEvent(final MagicGame game, final MagicEvent event) {
            if (event.isYes()) {
                ...
                game.addEvent(new MagicDiscardEvent(event.getPermanent(),event.getPlayer().getOpponent()));
            }
        }
    }
]
