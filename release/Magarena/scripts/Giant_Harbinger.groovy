...
def evt = {
    ...
    return new MagicEvent(
        ...
        choice,
        act,
        "PN may search his or her library for a Giant card, reveal it, shuffle his or her library, and put that card on top of it."
    );
}
[
       ...
       @Override
        public MagicEvent executeTrigger(final MagicGame game,final MagicPermanent permanent,final MagicPayedCost payedCost) {      
            return new MagicEvent(
                permanent,
                this,
                "PN may search his or her library for a Giant card, reveal it, put it into his or her hand, and shuffle his or her library."
            );
        }
        @Override
