[
    new MagicCDA() {
        ...
        public void modPowerToughness(final MagicGame game,final MagicPlayer player,final MagicPowerToughness pt) {
            final int size = game.filterPermanents(player,MagicTargetFilterFactory.TARGET_LAND_YOU_CONTROL).size();
            pt.set(size, size);
        }
    },
    new MagicBloodrushActivation(
        ...
        public void executeEvent(final MagicGame game,final MagicEvent event) {
            final int size = game.filterPermanents(event.getPlayer(),MagicTargetFilterFactory.TARGET_LAND_YOU_CONTROL).size();
