    ...
    new MagicWhenOtherSpellIsCastTrigger() {
        ...
        public MagicEvent executeTrigger(final MagicGame game,final MagicPermanent permanent,final MagicCardOnStack cardOnStack) {
            return new MagicEvent(
				...
				cardOnStack,
                this,
                ""+cardOnStack.getController().toString()+" puts X 1/1 green Squirrel creature tokens onto the battlefield, where X is the number of cards in all graveyards with the same name as RN."
            );
        }
        @Override
