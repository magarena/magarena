...
public enum AbilityIcon {
    ...
    private AbilityIcon(final MagicAbility ability, final String name, final MagicIcon defaultIcon, final String tooltip) {
        this.iconName = name;
        this.defaultIcon = defaultIcon != null ? IconImages.getIcon(defaultIcon) : null;
