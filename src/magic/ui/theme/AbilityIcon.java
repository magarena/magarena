...
public enum AbilityIcon {
    ...
    INTIMIDATE("Intimidate", IconImages.INTIMIDATE, "Intimidate is a static ability which restricts the types of creatures that can block a creature with intimidate. A creature with intimidate can't be blocked, except by artifact creatures and by creatures that share a color with it."),
