...
public class BattlefieldTextOverlay {
    ...
    public BufferedImage getOverlayImage(final int battlefieldWidth, final int batttlefieldHeight) {
        ...
        if (createNewImage) {
            textOverlayImage = GraphicsUtilities.getCompatibleBufferedImage(
        ...
        if (refreshOverlay) {
            ...
            GraphicsUtilities.clearImage(textOverlayImage);
    ...
    private void drawZoneName(final Graphics2D g2d) {
        ...
        GraphicsUtilities.drawStringWithOutline(g2d, zoneName, textX, textY, Color.YELLOW, Color.DARK_GRAY);
    }
