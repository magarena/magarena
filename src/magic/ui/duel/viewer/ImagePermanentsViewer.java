...
public class ImagePermanentsViewer extends JPanel {
    ...
    private static final float CARD_WIDTH = (float) GraphicsUtilities.getMaxCardImageSize().width;
    private static final float CARD_HEIGHT = (float) GraphicsUtilities.getMaxCardImageSize().height;
