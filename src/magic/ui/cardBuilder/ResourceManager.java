...
public class ResourceManager {
    ...
    public static final BufferedImage artifactGod = getFrame("gods/acard.jpg");
    public static final BufferedImage whiteGod = getFrame("gods/wcard.jpg");
    public static final BufferedImage whiteLandGod = getFrame("gods/wlcard.jpg");
    public static final BufferedImage blueGod = getFrame("gods/ucard.jpg");
    public static final BufferedImage blueLandGod = getFrame("gods/ulcard.jpg");
    public static final BufferedImage blackGod = getFrame("gods/bcard.jpg");
    public static final BufferedImage blackLandGod = getFrame("gods/blcard.jpg");
    public static final BufferedImage redGod = getFrame("gods/rcard.jpg");
    public static final BufferedImage redLandGod = getFrame("gods/rlcard.jpg");
    public static final BufferedImage greenGod = getFrame("gods/gcard.jpg");
    public static final BufferedImage greenLandGod = getFrame("gods/glcard.jpg");
    public static final BufferedImage multiGod = getFrame("gods/mcard.jpg");
    public static final BufferedImage multiLandGod = getFrame("gods/mlcard.jpg");
