//=========================================================================
//
//  This file was generated by Mouse 1.5 at 2012-12-15 13:01:35 GMT
...
public class MagicRuleParser extends magic.grammar.ParserMemo
{
  ...
  //    "sorcery" / "spirit or arcane" / "arcane" / "with infect" / "with
  ...
  private boolean SpellRestriction()
    {
      ...
      if (RestrictedPermanent()) return sem.action() && accept();
      return reject();
    }
