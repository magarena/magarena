//=========================================================================
//
//  This file was generated by Mouse 1.5 at 2012-12-15 12:57:51 GMT
...
public class MagicRuleParser extends magic.grammar.ParserMemo
{
  ...
  //    "noncreature" / "enchantment" / "spirit or arcane" / "artifact" /
  //    "during an opponent's turn" / "instant or sorcery" / "instant" /
  //    "sorcery" / "with infect" / "with converted mana cost " Number "
  //    or less" / "with converted mana cost " Number " or greater" /
  //    "with converted mana cost " Number / Tribal SPACE "creature" /
  //    Tribal ;
  //=====================================================================
  ...
  //-------------------------------------------------------------------
  //  SpellRestriction_3 = Tribal SPACE "creature"
  //-------------------------------------------------------------------
  private boolean SpellRestriction_3()
    {
      ...
      if (!Tribal()) return rejectInner();
      if (!SPACE()) return rejectInner();
      if (!next("creature")) return rejectInner();
      return acceptInner();
    }
  ...
  final Cache SpellRestriction_3 = new Cache("SpellRestriction_3"); // Tribal SPACE "creature"
  ...
  Cache[] cacheList =
  {
    ...
    AbilityRestriction,IfCondition,AnimateAction,AnimateVerb,
    ...
    SpellRestriction_2,SpellRestriction_3,RestrictedCard_0,
    RestrictedCreature_0,RestrictedCreature_1,RestrictedCreature_2,
    RestrictedCreature_3,RestrictedCreature_4,PermanentRestriction_0,
