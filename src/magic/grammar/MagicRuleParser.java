...
public class MagicRuleParser extends magic.grammar.ParserMemo
{
  ...
  Cache[] cacheList =
  {
    ...
    ExileAction,CounterAction,SelectOp,SelectCard,SelectCreature,
    SelectPermanent,SelectSpell,RestrictedPermanent,
    ...
    Permanent,Card,Spell,NoRegen,PowerToughness,SignedNumber,Number,
    Sign,SEP,EOC,SPACE,EOS,EOR,Rule_0,SpellEffect_0,Effect_0,
    SingleEffect_0,SingleEffect_1,SingleEffect_2,SingleEffect_3,
    SingleEffect_4,ActivatedAbility_0,ActivationCosts_0,
    TriggeredAbility_0,Keyword_0,Keyword_1,Keyword_2,Keyword_3,
    ...
    Keyword_22,Keyword_23,Keyword_24,ColorlessCost_0,ManaCost_0,
