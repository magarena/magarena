//=========================================================================
//
//  This file was generated by Mouse 1.5 at 2012-12-15 03:53:54 GMT
...
public class MagicRuleParser extends magic.grammar.ParserMemo
{
  ...
  //=====================================================================
  //  AnimateActionReminder = "it's still a land" / "that's still a land"
  //    ;
  //=====================================================================
  private boolean AnimateActionReminder()
    {
      if (saved(AnimateActionReminder)) return reuse();
      if (next("it's still a land")) return sem.action() && accept();
      if (next("that's still a land")) return sem.action() && accept();
      return reject();
    }
