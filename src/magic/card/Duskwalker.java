...
public class Duskwalker {                 
    private static MagicStatic Fear = new MagicStatic(MagicLayer.Ability) {
        @Override
        public long getAbilityFlags(
            final MagicGame game,
            final MagicPermanent permanent,
            final long flags) {
            return flags | MagicAbility.Fear.getMask();
        }
    };
        ...
        public void executeEvent(
            ...
            if (kicked) {
                game.doAction(new MagicChangeCountersAction(
                        ...
                        2,
                        true));
                game.doAction(new MagicAddStaticAction(permanent,Fear));
            }
        }
    };
}
