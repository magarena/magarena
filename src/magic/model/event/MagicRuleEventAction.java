...
public enum MagicRuleEventAction {
    ...
    public static MagicSourceEvent create(final String rule) {
        ...
        final String playerRule = rule.replaceAll("(D|d)raw ","PN draws ").replaceAll("(Y|y)ou gain","PN gains").replaceAll("(Y|y)ou lose","PN loses").replaceAll("(Y|y)our ","PN's ").replaceAll("(Y|y)ou ","PN");
