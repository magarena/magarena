...
public class MagicSearchOntoLibraryEvent extends MagicEvent {
    ...
    public MagicSearchOntoLibraryEvent(final MagicEvent event, final MagicChoice choice) {
        this(event.getSource(), event.getPlayer(), choice);
    }

    public MagicSearchOntoLibraryEvent(final MagicSource source, final MagicPlayer player, final MagicChoice choice) {
        super(
            source,
            player,
            choice,
