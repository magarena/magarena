...
public enum MagicIcon {
    ...
    MENU("w_menu5@18.png"),
    OPTIONS("w_book.png"),
    OPTIONBAR("w_book24.png"),
    REFRESH("w_refresh.png"),
    MULLIGAN("w_mulligan.png"),
    ...
    CUBE("w_cube.png"),
    LANDS("w_lands.png"),
    CREATURES("w_creatures.png"),
    ARTIFACTS("w_artifacts.png"),
    ENCHANTMENTS("w_enchantments.png"),
    INSTANTS("w_instants.png"),
    SORCERIES("w_sorceries.png"),
    PLANESWALKERS("w_planeswalkers.png"),
    SPELLS("w_spells.png"),
    STATS("w_stats.png"),
    EDIT("w_edit.png"),
    HELP("w_help.png"),
    OPEN("w_open.png"),
    CYCLE("w_cycle.png"),
    RANDOM("w_random32.png"),
    CLEAR("w_clear28.png"),
    FILTER("w_filter24.png"),
    ARROWDOWN("w_arrowdown.png"),
    ARROWUP("w_arrowup.png"),
