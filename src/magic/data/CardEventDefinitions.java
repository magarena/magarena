...
public class CardEventDefinitions {
	...
	private static final MagicSpellCardEvent INTO_THE_ROIL=new MagicSpellCardEvent("Into the Roil") {
	...
	private static final MagicSpellCardEvent PULSE_OF_THE_TANGLE=new MagicSpellCardEvent("Pulse of the Tangle") {
