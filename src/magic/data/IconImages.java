...
public class IconImages {
    ...
    public static final ImageIcon COST_PHYREXIAN_RED=loadSymbolIcon(48, false);
    public static final ImageIcon COST_PHYREXIAN_GREEN=loadSymbolIcon(49, false);
    ...
    private static ImageIcon loadSymbolIcon(final int pos, final boolean big) {
        ...
        if (big) {
            return new ImageIcon(magic.ui.utility.GraphicsUtilities.scale(subimage,bigW,bigH));
        } else {
            return new ImageIcon(magic.ui.utility.GraphicsUtilities.scale(subimage,icoW,icoH));
        }
    }
}
